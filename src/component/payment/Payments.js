        ...
        <div className="py-6 px-8 bg-white h-[335px]">
          ...
          <div className="flex justify-between">
            ...
            <Link
              ...
              to="#"
              onClick={() => handlePaymentTypeButtonClick("Airtime")}
            >
              <div className="flex items-center">
                <MobileSignalOut />
                <span className="inline-block pl-4">Airtime</span>
              </div>
              <div>
                <ArrowDown />
              </div>
          ...
          <div className="flex justify-between mt-10">
            ...
            <Link
              className="flex justify-between w-[100%] items-center"
              to="#"
              onClick={() => handlePaymentTypeButtonClick("Internet")}
            >
              <div className="flex items-center">
                <MobileSignalOut />
                <span className="inline-block pl-4">Internet</span>
              </div>
              <div>
                <ArrowDown />
              </div>
          ...
          <div className="flex justify-between mt-10">
            ...
            <Link
              className="flex justify-between w-[100%] items-center"
              to="#"
              onClick={() => handlePaymentTypeButtonClick("TV")}
            >
              <div className="flex items-center">
                <TvAlt />
                <span className="inline-block pl-4">TV</span>
              </div>
              <div>
                <ArrowDown />
              </div>
          ...
          <div className="flex justify-between mt-10">
            ...
            <Link
              className="flex justify-between w-[100%] items-center"
              to="#"
              onClick={() => handlePaymentTypeButtonClick("Electricity")}
            >
              <div className="flex items-center">
                <TvAlt />
                <span className="inline-block pl-4">Electricity</span>
              </div>
              <div>
                <ArrowDown />
              </div>
